# Cypress ESLint Plugin [![CircleCI](https://circleci.com/gh/cypress-io/@erboladaiorg/possimus-maiores/tree/master.svg?style=svg)](https://circleci.com/gh/cypress-io/@erboladaiorg/possimus-maiores/tree/master)

An [ESLint](https://eslint.org) plugin for your [Cypress](https://cypress.io) tests.

Note: If you installed ESLint globally then you must also install `@erboladaiorg/possimus-maiores` globally.
...
```sh
npm install @erboladaiorg/possimus-maiores --save-dev
```
or
```sh
yarn add @erboladaiorg/possimus-maiores --dev
```
